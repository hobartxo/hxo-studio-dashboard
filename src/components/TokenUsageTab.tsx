...
function ModelSplitBar({ gemini, openai }: { gemini: number; openai: number }) {
  ...
  return (
    <div style={{ width: "100%" }}>
      ...
      >
        <div style={{ width: `${g}%`, background: "var(--good)" }} />
        <div style={{ width: `${o}%`, background: "var(--accent)" }} />
      </div>
    </div>
  );
}
    ...
    <div style={{ display: "grid", gap: 10 }}>
      {last5.map((row) => {
        ...
        return (
          ...
          >
            <div style={{ color: "var(--muted)" }}>{shortDate(row.date)}</div>
            <div
              style={{
                height: 10,
                borderRadius: 999,
            ...
            <div style={{ textAlign: "right", color: "var(--muted)" }}>{number(total)}</div>
          </div>
        );
      })}
    </div>
    ...
    <div style={{ display: "grid", gap: 16 }}>
      ...
      <section className="grid-2">
        <article style={{ ...cardStyle, minHeight: 220 }}>
          ...
          <p style={{ marginTop: 10, color: "var(--muted)", fontSize: "0.95rem", lineHeight: 1.4 }}>
          ...
          <div style={{ marginTop: 14 }}>
            ...
            <ul style={{ marginLeft: 18, color: "var(--muted)", display: "grid", gap: 6 }}>
        ...
        <article style={{ ...cardStyle, minHeight: 220 }}>
          ...
          <div style={{ marginTop: 10, color: "var(--muted)", fontSize: "0.95rem" }}>
            Est. daily cost:{" "}
